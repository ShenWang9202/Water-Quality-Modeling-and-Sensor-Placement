function plotNet1BaseDemand_Pattern_tight
...
fontsize = 40;
ha = tight_subplot(2,1,[.1 .1],[.1 .1],[0.1,.01])
...
labelIndex = 1:11;
set(ha(1),'XTick',labelIndex);
set(ha(1),'XTickLabel',NodeID4Legend,'fontsize',fontsize);
hold on
ylabel('GPM')
...
ylim([0 3.7])
set(ha(2),'XTick',labelIndex);
set(ha(2),'XTickLabel',cellString,'fontsize',fontsize);
