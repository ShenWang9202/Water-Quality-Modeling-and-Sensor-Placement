function plotLinkConcentrations_3node(LinkID4Legend,X_link_control_result)
figure1 = figure
h1 = subplot(1,2,1)
fontsize = 38;
plot(X_link_control_result,'LineWidth',3);
...
plot(ranges,X_link_control_result(ranges,:),'LineWidth',3);
...
print(figure1,'EnlargedLinkConcentrations','-depsc2','-r300');
end