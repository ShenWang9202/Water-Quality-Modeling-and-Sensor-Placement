function plotSensoPostition_paper(sensorNumebers,numberofSensorsEachLayer,time,rawData,NodeID4Legend,filename,Hq_min,SimutionTimeInMinute)
...
fontsize = 32;
ha = tight_subplot(1,nLayers,[.01 .04],[.1 .14],[.1 .01])
for ii = 1:nLayers
    axes(ha(ii)); 
