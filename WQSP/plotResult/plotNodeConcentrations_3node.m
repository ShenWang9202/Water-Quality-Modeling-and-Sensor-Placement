function plotNodeConcentrations_3node(NodeID4Legend,X_node_control_result)
figure1 = figure
h1 = subplot(1,2,1)
fontsize = 38;
plot(X_node_control_result,'LineWidth',3);
...
plot(ranges,X_node_control_result(ranges,:),'LineWidth',3);
xticks([200 215])
...
print(figure1,'EnlargedNodeConcentrations','-depsc2','-r300');
end