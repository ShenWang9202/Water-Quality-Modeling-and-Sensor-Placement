...
hold on
plot(PredictedDemandSum,'LineWidth',1.5);
...
box on
lgd = legend({'Predicted','Actual'},'Location','northoutside','Interpreter','Latex','Orientation','horizontal');
...
xlabel('Time (minute)','FontSize',fontsize -5,'interpreter','latex')
ylabel({'Demand';' (GPM)'},'FontSize',fontsize - 5,'interpreter','latex')

set(gcf,'PaperUnits','inches','PaperPosition',[0 0 8 4])
print(figure1,['Demand1day_3node'],'-depsc2','-r300');
