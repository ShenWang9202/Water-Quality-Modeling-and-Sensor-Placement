function plotSensorPerformance(numberofSensors,achieved,filename)

nSensorEachLayer = numberofSensors(1,2:end); % remove 0 sensors
achieved = achieved(:,2:end); % remove the data of 0 sensors
figure1 = figure();
[time,nLayers] = size(achieved);
% nPoints = 288;  % Number of data points
