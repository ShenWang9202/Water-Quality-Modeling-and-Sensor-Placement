function [A_J_New, B_J_New]= ConstructMatrixForJunction_D_Decay(CurrentFlow,MassEnergyMatrix,flipped,ElementCount,IndexInVar,q_B,A_J,B_J,aux,JunctionReactionCoeff)
...
%% find the downstream node of pump and valves
...
%              A_J(i,lastSegmentIndex) = contributionC(i,Col(j));
            ...
            if(isPipe)
                ...
                A_J(i,lastSegmentIndex) = contributionC(i,Col(j));
                A_J(i,i) = JunctionReactionCoeff; % make it decay a little bit to make A full rank
            end
        end
    end
end
